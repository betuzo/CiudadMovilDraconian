...
NSString *const RESOURCE_GET_PASAJEROS_COMPARTIDOS = @"/taxisi-backend/api/pasajero/compartir/";

NSString *const RESOURCE_GET_INCIDENTES = @"/taxisi-backend/api/incidenteVial/ubicacion/";

NSString *const RESOURCE_GET_ORBRAS = @"/taxisi-backend/api/obras/ubicacion/";
